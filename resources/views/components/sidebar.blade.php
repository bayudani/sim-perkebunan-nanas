<aside class="fixed inset-y-0 left-0 w-64 bg-emerald-800 text-white flex flex-col shadow-2xl transition-all duration-300 z-50">
    <!-- Header Logo -->
    <div class="flex items-center justify-center h-20 border-b border-emerald-700/50 bg-emerald-900/30">
    ...
    <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
        ...
        <!-- Biaya Operasional (Bisa diakses semua, tapi hak CRUD dipisah di controller/view nanti) -->
